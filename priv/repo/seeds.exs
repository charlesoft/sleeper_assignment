...
network_partition_four = Repo.insert!(%NetworkPartition{cluster_id: cluster_two.id})
...
node_twelve =
  Repo.insert!(%Node{
    ...
    status: :up,
    cluster_id: cluster_two.id,
    network_partition_id: network_partition_four.id
  })
